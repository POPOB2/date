...
<div class="outer_table">
    <div class="leftYear">
        <a href="13_index.php?year=<?=($_GET['year']-1)?>&month=<?=$_GET['month'];?>"><i class="fa-solid fa-angles-left"></i>上一年</a>
    </div>
    <div class="leftMonth">
        <a href="13_index.php?year=<?=$prevYear?>&month=<?=$prevMonth;?>">&nbsp;&nbsp;<i class="fa-solid fa-angle-left"></i> 上一月</a>
    </div>
    <!-- 月曆 周與日 week_table -->
    <div class="week_table">
        <a class="starting_point" href="13_index.php"><i class="fa-solid fa-clock-rotate-left"></i> 回到現在</a>
...
<div class="rightMonth">
    <a href="13_index.php?year=<?=$nexYear?>&month=<?=$nextMonth;?>">下一月 <i class="fa-solid fa-angle-right"></i>&nbsp;&nbsp;</a>
</div>
<div class="rightYear">
    <a href="13_index.php?year=<?=($_GET['year']+1);?>&month=<?=$_GET['month'];?>">下一年<i class="fa-solid fa-angles-right"></i></a>
</div>
